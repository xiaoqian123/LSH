...
public class CreateTable {
	...
	private static void creatTableImage() {
		...
		String sql  = "create table Image(id int not null auto_increment,pid varchar(10),phase varchar(100),Bcid varchar(50),enlength int,imagetype varchar(10), primary key(id)) default charset=utf8;";
